...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "fivesixnine.splash.splash.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "fivesixnine.splash.splash.MsgCreatePostResponse")
	proto.RegisterType((*MsgUpdatePost)(nil), "fivesixnine.splash.splash.MsgUpdatePost")
	proto.RegisterType((*MsgUpdatePostResponse)(nil), "fivesixnine.splash.splash.MsgUpdatePostResponse")
	proto.RegisterType((*MsgDeletePost)(nil), "fivesixnine.splash.splash.MsgDeletePost")
	proto.RegisterType((*MsgDeletePostResponse)(nil), "fivesixnine.splash.splash.MsgDeletePostResponse")
}
...
var fileDescriptor_40893c9ce6cb4b4c = []byte{
	...
	0x2c, 0xce, 0xd0, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x92, 0x4c, 0xcb, 0x2c,
	...
	0x46, 0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x3e, 0x92, 0xa9, 0xfa, 0xd0, 0x24, 0x5f, 0x01, 0x63,
	0x94, 0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0xd3, 0xbf, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff,
	0x42, 0xed, 0x56, 0x80, 0x12, 0x03, 0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fivesixnine.splash.splash.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdatePost(ctx context.Context, in *MsgUpdatePost, opts ...grpc.CallOption) (*MsgUpdatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fivesixnine.splash.splash.Msg/UpdatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeletePost(ctx context.Context, in *MsgDeletePost, opts ...grpc.CallOption) (*MsgDeletePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fivesixnine.splash.splash.Msg/DeletePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fivesixnine.splash.splash.Msg/CreatePost",
	}
...
func _Msg_UpdatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fivesixnine.splash.splash.Msg/UpdatePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeletePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fivesixnine.splash.splash.Msg/DeletePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fivesixnine.splash.splash.Msg",
