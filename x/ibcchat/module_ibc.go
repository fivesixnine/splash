...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.IbcchatPacketData
	...
	case *types.IbcchatPacketData_IbcmessagePacket:
		err := am.keeper.OnRecvIbcmessagePacket(ctx, modulePacket, *packet.IbcmessagePacket)
		if err != nil {
			acknowledgement = channeltypes.NewErrorAcknowledgement(err.Error())
		}
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeIbcmessagePacket,
...
func (am AppModule) OnAcknowledgementPacket(
	...
	case *types.IbcchatPacketData_IbcmessagePacket:
		err := am.keeper.OnAcknowledgementIbcmessagePacket(ctx, modulePacket, *packet.IbcmessagePacket, ack)
		if err != nil {
			return nil, err
		}
		eventType = types.EventTypeIbcmessagePacket
	default:
		errMsg := fmt.Sprintf("unrecognized %s packet type: %T", types.ModuleName, packet)
...
func (am AppModule) OnTimeoutPacket(
	...
	case *types.IbcchatPacketData_IbcmessagePacket:
		err := am.keeper.OnTimeoutIbcmessagePacket(ctx, modulePacket, *packet.IbcmessagePacket)
		if err != nil {
			return nil, err
		}
	default:
